...
export default function Register() {
    ...
    useEffect(() => {
// Ensure email is valid, password meets length requirement, and passwords match
...
// Handle specific backend messages
    ...
    return (
        ...
        <Button variant={isActive ? "primary" : "danger"} type="submit" disabled={!isActive}>Submit</Button>
        </Form>
        );
    }